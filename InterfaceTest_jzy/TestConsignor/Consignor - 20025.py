...
class Consignor20025(object):
    ...
    def inter_datas(self):
        return {
            ...
            "params": {
                "type": "1",  # 1-待提货,2-待提货,3-在途中 4-已完成,5-已取消,6-异常订单
                "endDate": "",  # (用于请求下一页数据)上次请求最后一条时间,请求这个时间点之后数据,第一次不带
            }
        }

    def interface_20025(self):
        return self.intface.get_result(self.inter_datas())


if __name__ == '__main__':
    main = Consignor20025()
    print(main.interface_20025().text)
