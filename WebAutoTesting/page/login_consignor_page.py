...
class LoginPage(object):
    ...
    def ele_type_top(self):
        return self.find_element.get_ele("login_consignor", "userTypetop")

    @property
    def ele_type_bottom(self):
        return self.find_element.get_ele("login_consignor", "userTypebottom")

    @property
    def ele_username(self):
        return self.find_element.get_ele("login_consignor", "username")

    @property
    def ele_password(self):
        return self.find_element.get_ele("login_consignor", "password")

    @property
    def ele_cod(self):
        return self.find_element.get_ele("login_consignor", "verificationCode")

    @property
    def ele_login_button(self):
        return self.find_element.get_ele("login_consignor", "btn")

    @property
    def cod_error(self):
        try:
            self.find_element.get_ele("login_consignor", "loginError")
            return True
        except ECelement:
            return False
    ...
    def wrapper_title(self):
        try:
            self.find_element.get_ele("login_consignor", "loginTitle")
            return True
        except ECelement:
            return False
