...
class MyCarrier(object):
    def __init__(self, driver):
        self.driver = driver
        self.path = r"D:\python\WebAutoTesting\config\MyCarrierFrameIni.ini"
    ...
    @property
    def ele_op_remove(self):
        return self.element.get_ele("click", "op_remove")
